...
function onLoad() {
    ...
    var wall1 = new THREE.Mesh(xGeometry, materials[1]);
    var wall2 = new THREE.Mesh(xGeometry, materials[2]);
    var wall3 = new THREE.Mesh(zGeometry, materials[3]);
    var wall4 = new THREE.Mesh(zGeometry, materials[4]);
    wall1.position.x = roomX;
    wall2.position.x = -roomX;
    wall3.position.z = roomZ;
    wall4.position.z = -roomZ;
    ...
    var floorGeometry = new THREE.BoxGeometry(1000, 0.1, 1000);
